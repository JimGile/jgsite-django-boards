...
class ReplyTopicTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse('boards:reply_topic', kwargs={'board_id': self.board.pk, 'topic_id': self.topic.pk})
...
class SuccessfulReplyTopicTests(ReplyTopicTestCase):
    ...
    def test_redirection(self):
        ...
        '''
        topic_posts_url = reverse('boards:topic_posts', kwargs={'board_id': self.board.pk, 'topic_id': self.topic.pk})
